...
import com.hazelcast.web.PentahoHazelcastWebFilter;
import com.hazelcast.web.PentahoSerializableHazelcastHttpSession;
 ...
 */
public class PentahoHazelcastSpringAwareWebFilter extends PentahoHazelcastWebFilter {

    protected volatile SessionRegistry sessionRegistry;

    public PentahoHazelcastSpringAwareWebFilter() {
    }

    public PentahoHazelcastSpringAwareWebFilter(Properties properties) {
        super(properties);
    }
    ...
    protected HazelcastHttpSession createNewSession(HazelcastRequestWrapper requestWrapper,
        ...
        PentahoSerializableHazelcastHttpSession session =
                (PentahoSerializableHazelcastHttpSession) super.createNewSession(requestWrapper, create, existingSessionId);
